        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/tea1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                        <h4 class="siz text-white text-uppercase mb-md-3">Welcome Aboard</h4>
                            <h1 class="sizz text-justify text-white ">Fly with us and have a better experience of continental foods</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/tea2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                        <h4 class="siz text-white text-uppercase mb-md-3">Welcome Aboard</h4>
                            <h1 class="sizz text-justify text-white ">Fly with us and have a better experience of continental foods</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/tea3.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                        <h4 class="siz text-white text-uppercase mb-md-3">Welcome Aboard</h4>
                            <h1 class="sizz text-justify text-white ">Fly with us and have a better experience of continental foods</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/plane.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                        <h4 class="siz text-white text-uppercase mb-md-3">Welcome Aboard</h4>
                            <h1 class="sizz text-justify text-white">Fly with us and have a better experience of continental foods</h1>
