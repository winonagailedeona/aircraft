...
<div class="col-3" style="padding-right: 5%; "><a href="<?php echo base_url('confirmedorders');?>" style="font-size: 77%; background-color: #2b9bc2" class="btn btn-app bg-secondary">
