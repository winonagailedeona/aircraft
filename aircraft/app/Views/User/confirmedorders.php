    ...
    <div class="container mt-3">
        ...
        <div class="card text-center" style="height: 80px;">
            ...
            <div class="row">
                ...
                <div class="col-3" style="padding-right: 5%; "><a href="<?php echo base_url('confirmedorders'); ?>" style="font-size: 16px;" class="btn btn-app bg-secondary">
                                        ...
                                        <div class="gold-members p-4">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        <span class="float-right text-info"><?= $orders['status'] ?><i class="icofont-check-circled text-success"></i></span>
                                                    </p>
                                                    <h6 class="mb-2">
                                                        <p class="text-dark"><?= $orders['productname'] ?></p>
                                                    </h6>

                                                    <p class="text-dark">x <?= $orders['orquantity'] ?>
                                                    </p>
                                                    <?php $status = $orders['type'];
                                                    if ($status == "D" or $status == "P") { ?>

                                                        <?php if ($status == "D") { ?>
                                                            <p class="text-dark">Dine-in
                                                            </p>
                                                        <?php } ?>
                                                        <?php if ($status == "P") { ?>
                                                            <p class="text-dark">Pick-up
                                                            </p>
                                                        <?php } ?>
                                                    <?php } ?>
        ...
        if (empty($orders)) : ?>
            <div class="bg-white card mb-4 order-list shadow-sm">
                <div style="height: 500px;">
                    ...
                    <h5 style="margin-top: 20%;" class="text-muted text-center">No Orders Yet!</h5>
                </div>
