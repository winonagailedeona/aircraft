        ...
        <div class="login-wrapper my-auto">
          <form action="<?php echo base_url(); ?>/SignupController/store" method="post">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" placeholder="e.g. Juan Dela Cruz" value="<?= set_value('name') ?>">
            </div>
            <div class="form-group">
              <label>Email</label>
              <input type="email" name="email" class="form-control" placeholder="name@example.com" value="<?= set_value('email') ?>">
            </div>
            ...
            <input type="submit" class="btn btn-block login-btn" type="button" value="Register">
          </form>
          <p class="login-wrapper-footer-text text-center">Already have an account? <a href="<?= base_url('signin') ?>" class="text-reset"><b>Log In</b></a></p>
        </div>
      </div>
