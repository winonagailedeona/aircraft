...
<body>
    ...
    <!-- Header Start -->
    <div class="jumbotron jumbotron-fluid pas">
        <div class="container text-center">
            <h1 class="text-white display-3">Pasta</h1>
            ...
            <div class="col-lg-3 py-2">
              <div class="d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                  <div class="bg-dark mt-n5 mb-2 py-3" style="width: 100px;">
                    <h4 class="font-weight-bold text-white mb-0">₱ <?=number_format($pr['price'], 2)?></h4>
                  </div>
